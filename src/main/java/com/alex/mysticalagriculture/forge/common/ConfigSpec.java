...
public class ConfigSpec extends UnmodifiableConfigWrapper<UnmodifiableConfig> {
    ...
    private ConfigSpec(UnmodifiableConfig storage, UnmodifiableConfig values, Map<List<String>, String> levelComments, Map<List<String>, String> levelTranslationKeys) {
        super(storage);
        this.values = values;
    ...
    public synchronized int correct(CommentedConfig config, com.electronwill.nightconfig.core.ConfigSpec.CorrectionListener listener) {
        return correct(config, listener, null);
    }

    public synchronized int correct(CommentedConfig config, com.electronwill.nightconfig.core.ConfigSpec.CorrectionListener listener, com.electronwill.nightconfig.core.ConfigSpec.CorrectionListener commentListener) {
    ...
    private int correct(UnmodifiableConfig spec, CommentedConfig config, LinkedList<String> parentPath, List<String> parentPathUnmodifiable, com.electronwill.nightconfig.core.ConfigSpec.CorrectionListener listener, com.electronwill.nightconfig.core.ConfigSpec.CorrectionListener commentListener, boolean dryRun)
    {
        int count = 0;
        ...
        for (Map.Entry<String, Object> specEntry : specMap.entrySet())
        {
            ...
            final com.electronwill.nightconfig.core.ConfigSpec.CorrectionAction action = configValue == null ? ADD : REPLACE;
    ...
    public static class Builder
    {
        ...
        public <T> Pair<T, ConfigSpec> configure(Function<Builder, T> consumer) {
        ...
        public ConfigSpec build()
        {
            ...
            ConfigSpec ret = new ConfigSpec(storage, valueCfg, levelComments, levelTranslationKeys);
    ...
    public static class ConfigValue<T> implements Supplier<T>
    {
         ...
         * @throws NullPointerException if the {@link ConfigSpec config spec} object that will contain this has
         *                              not yet been built
