...
public class RecipeSerializers {
    ...
    public static void registerRecipeSerializers() {
        ...
        Registry.register(Registry.RECIPE_SERIALIZER, new ResourceLocation("mysticalagriculture:reprocessor"), REPROCESSOR);
        Registry.register(Registry.RECIPE_SERIALIZER, new ResourceLocation("mysticalagriculture:soul_extraction"), SOUL_EXTRACTION);
        Registry.register(Registry.RECIPE_SERIALIZER, new ResourceLocation("mysticalagriculture:soul_jar_empty"), CRAFTING_SOUL_JAR_EMPTY);
