...
public class ModBiomeModifiers {
    ...
    public static void registerBiomeModifiers() {
        INFERIUM_ORE_KEY = ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(MOD_ID,"inferium_ore"));
        PROSPERITY_ORE_KEY = ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(MOD_ID,"prosperity_ore"));
        SOULSTONE_KEY = ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(MOD_ID,"soulstone"));
