...
import com.alex.mysticalagriculture.cucumber.item.tool.BaseCrossbowItem;
...
public class EssenceCrossbowItem extends BaseCrossbowItem implements Tinkerable {
    ...
    public EssenceCrossbowItem(ToolMaterial tier, int tinkerableTier, int slots, float drawSpeedMulti, Function<Settings, Settings> settings) {
