...
import com.alex.mysticalagriculture.items.MysticalFertilizerItem;
...
public class EssenceShearsItem extends BaseShearsItem implements Tinkerable {
    private static final EnumSet<AugmentType> TYPES = EnumSet.of(AugmentType.TOOL, AugmentType.FISHING_ROD);
    private final int tinkerableTier;
    private final int slots;

    public EssenceShearsItem(ToolMaterial toolMaterial, int tinkerableTier, int slots, Function<Settings, Settings> settings) {
