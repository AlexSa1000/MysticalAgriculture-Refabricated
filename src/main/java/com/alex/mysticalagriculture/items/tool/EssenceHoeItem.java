...
import com.alex.mysticalagriculture.util.item.tool.BaseHoeItem;
...
public class EssenceHoeItem extends BaseHoeItem implements Tinkerable {
    ...
    public EssenceHoeItem(ToolMaterial tier, int tinkerableTier, int slots, int attackDamage, Function<Settings, Settings> settings) {
        super(tier, attackDamage, tinkerableTier - 1.0F, settings);
