...
public class EssenceBootsItem extends BaseArmorItem implements Tinkerable {
    ...
    public EssenceBootsItem(ArmorMaterial material, int tinkerableTier, int slots, Function<Settings, Settings> settings) {
    ...
    public void inventoryTick(ItemStack stack, World world, Entity entity, int slot, boolean selected) {
        if (entity instanceof PlayerEntity && slot == 0) {
